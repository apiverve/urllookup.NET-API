...
namespace APIVerve
{
    public class URLLookupAPIClient
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/urllookup";
        ...
        public URLLookupAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public URLLookupAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, URLLookupQueryOptions options = null)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public ResponseObj Execute(URLLookupQueryOptions options = null)
        {
            try
            {
                if (_isDebug)
        ...
        private string constructURL(URLLookupQueryOptions options)
        {
